...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2023 at 09:41 AM
...
CREATE TABLE `favoris` (
  ...
  `exercice` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `favoris` (`id`, `utilisateur`, `exercice`) VALUES
(1, 'hassan123', 'Abdominaux - Crunchs'),
(2, 'hassan123', 'Abdominaux - Planche');
...
INSERT INTO `programme` (`id`, `nom`, `description`, `utilisateur_id`) VALUES
(1, 'Programme d Entraînement Débutant', 'Un programme adapté aux débutants', 1),
(2, 'Programme de Renforcement Musculaire Avancé', 'Un programme avancé pour le renforcement musculaire', 2);
...
--
-- Dumping data for table `programme_exercice`
--
...
(1, 'hassan123', 'ghandour', 'hassan', 'hassan.ghandour@student.junia.com', '789', '2023-11-19 09:03:15', 'utilisateur'),
(2, 'nick', 'ghandour', 'kssem', 'kassem.ghandour@student.junia.com', '456', '2023-11-19 09:08:33', 'utilisateur'),
(7, 'kassem1', 'ghandour', 'kassem', 'kassem.ghandour@gmail.com', '456', '2023-12-05 08:35:44', 'utilisateur');
...
ALTER TABLE `utilisateur`
  ...
  ADD UNIQUE KEY `idx_Nickname_unique` (`Nickname`),
...
--
ALTER TABLE `favoris`
  ADD CONSTRAINT `favoris_ibfk_1` FOREIGN KEY (`utilisateur`) REFERENCES `utilisateur` (`Nickname`),
  ADD CONSTRAINT `favoris_ibfk_2` FOREIGN KEY (`exercice`) REFERENCES `exercice` (`nom`);
